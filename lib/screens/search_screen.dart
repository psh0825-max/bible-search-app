...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Navigator로 단독 push되는 화면이므로 Scaffold(Material)가 꼭 필요하다.
    // 없으면 모든 텍스트가 기본 스타일(노란 밑줄)로 렌더링된다.
    return Scaffold(
      body: Container(
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color:
                                    AppConstants.bgCard.withValues(alpha: 0.78),
                                border: Border.all(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: isPrimary
              ? null
              : AppConstants.bgCardLight.withValues(alpha: 0.7),
          border: isPrimary
              ? null
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            isInitial ? '어떤 말씀을 찾아드릴까요?' : '딱 맞는 결과가 없어요',
            style: Theme.of(context).textTheme.headlineSmall,
          ),
          const SizedBox(height: 6),
          Text(
            isInitial ? '키워드를 입력하면 바로 찾아드려요.' : '다른 단어로 다시 찾아보세요.',
            style: Theme.of(context).textTheme.bodyMedium,
          ),
        ],
      ),
